        ...
        <div className="flex w-full justify-center">
          ...
          >
            ...
            {features?.map((feature) => (
              <TabsContent key={feature.slug} value={feature.slug} className="mt-8 w-full">
                <div className="w-full">
                  <div className="mb-8 space-y-4 lg:hidden">
                    {feature.options.map(({ text }, index) => (
                  ...
                  <div className="w-full">
                    <AspectRatio ratio={16 / 9}>
                      <Image
                        src={feature.image_desktop.formats.large.url || "https://ui.shadcn.com/placeholder.svg"}
                        alt={feature.title || "Tab content image"}
                        fill
                        blurDataURL={feature.image_desktop.formats.thumbnail.url}
                        className="hidden h-full w-full rounded-xl object-contain lg:block"
                      />
                      <Image
                        src={feature.image_mobile.url || "https://ui.shadcn.com/placeholder.svg"}
                        alt={feature.title || "Tab content image"}
                        fill
                        blurDataURL={feature.image_mobile.formats.thumbnail.url}
